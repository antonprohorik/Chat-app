...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    if (!formData.fullName.trim()) return toast.error("Имя и фамилия обязательны");
    if (!formData.email.trim()) return toast.error("Email обязателен");
    if (!/\S+@\S+\.\S+/.test(formData.email)) return toast.error("Неверный формат email");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-base-content/60">Начните создание вашего аккаунта</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        title="Присоединяйтесь к нашему сообществу"
